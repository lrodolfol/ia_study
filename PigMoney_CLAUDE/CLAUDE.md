...
- Naming rules: `./claude/rules/rules.naming.md`
- Architecture rules: `./claude/rules/rules.architecture.md`
- Style and flow rules: `./claude/rules/rules.style.md`
- Platform/build rules: `./claude/rules/rules.platform.md`
